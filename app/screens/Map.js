...
const google_api_key = 'AIzaSyAPpo2cz_zc2u3V5SNdobQv5LxJkoCUr5A';
const base_url = 'http://385d989e.ngrok.io';
const pusher_app_key = 'ecdb9a2a6e01d5fd8842';
  ...
  componentDidMount() {
    ...
    navigator.geolocation.getCurrentPosition(
      (position) => {
        ...
        Geocoder.getFromLatLng(coords)
        .then((response) => {
        
          this.from_region = coords;
